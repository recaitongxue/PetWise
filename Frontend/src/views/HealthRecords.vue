...
.dist-bar.weight { background: linear-gradient(90deg, var(--color-primary), var(--color-accent-dark)); }
...
.status-card.weight { border-left-color: var(--color-primary); }
...
.record-type-badge.weight { background: #e6e9ff; color: var(--color-primary); }
